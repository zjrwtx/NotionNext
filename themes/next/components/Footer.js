  ...
  return (
        ...
        >
            ...
            <span>
                ...
                <br />
                <h1>{title}</h1>
                <span className='text-xs font-serif  text-gray-500 dark:text-gray-300 '> 创始人:正经人王同学<a href='https://mp.weixin.qq.com/s/OXjOVSswjGxhJ4SyW8j6IQ' className='underline '>公众号:迷糊AI实验室</a>.</span>
            </span>
        </footer>
  )
}
